Shader "Unlit/NewUnlitShader"
{
    ...
    SubShader
    {
        ...
        Pass
        {
			...
			//SCALE
			static float2x2 scale(float2 _scale) {
				float2x2 e = float2x2(_scale.x, 0.0,
					0.0, _scale.y);
				return e;
			}
			...
			static float ridgedMF(float2 p) {
			...
			static float3 hsb2rgb(in float3 c) {
			...
			fixed4 frag(v2f i) : SV_Target
			{
				...
				*/
				...
				//lerping color1 and color2 with the pattern
